    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='lesson_images/')),
            ],
            options={
                'verbose_name': 'Sınıf',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ManyToManyField(related_name='users', to='account.departmentmodel', verbose_name='Bölümü')),
